...
//  EssentialFeedTests
//
//  Created by Jaime Leon Parada on 1/11/22.
//
...
final class CodableFeedStoreTests: XCTestCase {
    ...
    func test_retrieve_deliversFoundValuesOnNonEmptyCache() {
        ...
        insert((feed: feed, timestamp), to: sut)
    ...
    private func expect(_ sut: CodableFeedStore, toRetrieve expectedResult: RetrieveCacheFeedResult, file: StaticString = #file, line: UInt = #line) {
        ...
        sut.retrieve { retrievedResultd in
            switch (expectedResult, retrievedResultd) {
            ...
            default:
                XCTFail("Expected to retrieve \(expectedResult), got \(retrievedResultd) instead", file: file, line: line)
            }
